...
export default function Button({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "h-12 rounded-full px-[22px] text-center text-label-md transition-all duration-150 truncate focus-visible:outline-2 focus-visible:outline-focus focus-visible:outline-offset-2 disabled:cursor-not-allowed",
